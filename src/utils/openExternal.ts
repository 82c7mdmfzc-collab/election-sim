...
// Community links (https only — the opener capability is scoped to https://* plus
// mailto:* for the in-app Report flow, and no LSApplicationQueriesSchemes is
// declared, so app schemes like discord:// would be blocked; the https
// invite/profile URLs open the app-or-web from Safari fine).
