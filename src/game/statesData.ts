...
const RAW_STATES: Array<Omit<US_State, 'maxRungs'>> = [
  ...
  { id:'AK', name:'Alaska',               electoralVotes:3,  baseCampaignCost:6   },
  ...
  { id:'HI', name:'Hawaii',               electoralVotes:4,  baseCampaignCost:8   },
  { id:'ID', name:'Idaho',                electoralVotes:4,  baseCampaignCost:8   },
  ...
  { id:'MT', name:'Montana',              electoralVotes:4,  baseCampaignCost:8   },
  { id:'NE', name:'Nebraska',             electoralVotes:5,  baseCampaignCost:10  },
  ...
  { id:'ND', name:'North Dakota',         electoralVotes:3,  baseCampaignCost:6   },
  ...
  { id:'RI', name:'Rhode Island',         electoralVotes:4,  baseCampaignCost:8   },
  { id:'SC', name:'South Carolina',       electoralVotes:9,  baseCampaignCost:42  },
  { id:'SD', name:'South Dakota',         electoralVotes:3,  baseCampaignCost:6   },
